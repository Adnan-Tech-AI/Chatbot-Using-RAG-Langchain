...
# Create or get the collection on ChromaDB
collection_name = 'Techzone_data'
Data = ch_client.create_collection(name=collection_name)

# Add documents to ChromaDB
Data.add(documents=persist_directory)

# Query ChromaDB
query_result = Data.query()

# Continue your Streamlit app code...
